...
class ContentPreTrainTTSInterface(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if not tts_model_path.endswith(".pt"):
            ...
            tts_model_path = os.path.join(MODELS_DIR, f"UnetTTS_{tts_model_path}","Content_Encoder", "best.pt")
        ...
        self.phone2mel = ContentPreTrain(weights=checkpoint["model"])  # multi speaker multi language
