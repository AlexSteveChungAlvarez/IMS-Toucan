...
from Layers.INConformer import INConformer
...
class UnetTTS(torch.nn.Module):
    ...
    def forward(self,
        ...
        # calculate loss
        l1_loss, duration_loss = self.criterion(mel_after,
                                                         mel_before,
                                                         gold_speech,
                                                         speech_lengths,
                                                         text_lengths,
        ...
        if return_mels:
            ...
            return l1_loss, duration_loss, glow_loss, mel_after
    ...
    def _forward(self, 
        ...
        content_latents,predicted_durations = self.content_encoder(text_tensors,text_lengths,utterance_embedding,lang_ids,gold_durations,is_inference)
        #content_latents_pred = self.in_encoder(text_tensors,text_masks,lang_ids)
        ...
        decoded_spectrogram = self.ada_in_decoder(content_latents, decoder_masks, utterance_embedding)
        ...
        if is_inference:
            ...
            return decoded_spectrogram, refined_spectrogram, predicted_durations, glow_loss
