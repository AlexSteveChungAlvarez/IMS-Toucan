...
def run(gpu_id, resume_checkpoint, finetune, model_dir, resume, use_wandb, wandb_resume_id):
    ...
    if model_dir is not None:
        ...
        save_dir = os.path.join(MODELS_DIR, "ToucanTTS_Quechua_and_Spanish")  # RENAME TO SOMETHING MEANINGFUL FOR YOUR DATA
    ...
    all_train_sets.append(ConcatDataset(quechua_datasets))
    ...
    all_train_sets.append(ConcatDataset(spanish_datasets))
    ...
    train_loop(net=model,
               ...
               eval_lang="qu",  # THE LANGUAGE YOUR PROGRESS PLOTS WILL BE MADE IN
               warmup_steps=500,
